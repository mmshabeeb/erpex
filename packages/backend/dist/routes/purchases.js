...
purchaseOrderRoutes.get('/', async (req, res, next) => {
    try {
        res.json({ success: true, ...(await poService.listPurchaseOrders(req.companyId, req.query)) });
    }
    catch (e) {
        next(e);
    }
...
purchaseOrderRoutes.get('/:id', async (req, res, next) => {
    try {
        res.json({ success: true, data: await poService.getPurchaseOrder(req.companyId, req.params.id) });
    }
    catch (e) {
        next(e);
    }
...
purchaseOrderRoutes.post('/', async (req, res, next) => {
    try {
        res.status(201).json({ success: true, data: await poService.createPurchaseOrder(req.companyId, req.body) });
    }
    catch (e) {
        next(e);
    }
...
purchaseOrderRoutes.patch('/:id/status', async (req, res, next) => {
    try {
        res.json({ success: true, data: await poService.updatePurchaseOrderStatus(req.companyId, req.params.id, req.body.status) });
    }
    catch (e) {
        next(e);
    }
...
purchaseOrderRoutes.post('/:id/convert-bill', async (req, res, next) => {
    try {
        res.json({ success: true, data: await poService.convertToBill(req.companyId, req.params.id) });
    }
    catch (e) {
        next(e);
    }
...
billRoutes.get('/', async (req, res, next) => {
    try {
        res.json({ success: true, ...(await billService.listBills(req.companyId, req.query)) });
    }
    catch (e) {
        next(e);
    }
...
billRoutes.get('/unpaid/:contactId', async (req, res, next) => {
    try {
        res.json({ success: true, data: await billService.getUnpaidBills(req.companyId, req.params.contactId) });
    }
    catch (e) {
        next(e);
    }
...
billRoutes.get('/:id', async (req, res, next) => {
    try {
        res.json({ success: true, data: await billService.getBill(req.companyId, req.params.id) });
    }
    catch (e) {
        next(e);
    }
...
billRoutes.post('/', async (req, res, next) => {
    try {
        res.status(201).json({ success: true, data: await billService.createBill(req.companyId, req.body) });
    }
    catch (e) {
        next(e);
    }
...
billRoutes.post('/:id/post', async (req, res, next) => {
    try {
        res.json({ success: true, data: await billService.postBill(req.companyId, req.params.id) });
    }
    catch (e) {
        next(e);
    }
...
expenseRoutes.get('/', async (req, res, next) => {
    try {
        res.json({ success: true, ...(await expenseService.listExpenses(req.companyId, req.query)) });
    }
    catch (e) {
        next(e);
    }
...
expenseRoutes.post('/', async (req, res, next) => {
    try {
        res.status(201).json({ success: true, data: await expenseService.createExpense(req.companyId, req.body) });
    }
    catch (e) {
        next(e);
    }
...
paymentMadeRoutes.get('/', async (req, res, next) => {
    try {
        res.json({ success: true, ...(await paymentMadeService.listPaymentsMade(req.companyId, req.query)) });
    }
    catch (e) {
        next(e);
    }
...
paymentMadeRoutes.post('/', async (req, res, next) => {
    try {
        res.status(201).json({ success: true, data: await paymentMadeService.createPaymentMade(req.companyId, req.body) });
    }
    catch (e) {
        next(e);
    }
