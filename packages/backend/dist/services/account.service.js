...
export async function getAccountTree(companyId) {
...
// ─── Get Single Account ─────────────────────────────────────
export async function getAccount(companyId, id) {
...
export async function createAccount(companyId, data) {
    ...
    if (existing)
        throw new AppError(`Account code "${data.code}" already exists`, 409);
...
// ─── Update Account ─────────────────────────────────────────
export async function updateAccount(companyId, id, data) {
...
export async function getAccountLedger(companyId, accountId, startDate, endDate) {
...
export async function getCashBankAccounts(companyId) {
    return prisma.account.findMany({
