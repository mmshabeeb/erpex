...
async function provisionChartOfAccounts(companyId, isIndia) {
    const ids = {};
    // Helper to create account and track its ID
    async function createAcct(code, name, type, parentKey, opts) {
...
async function provisionGSTTaxConfigs(companyId, accountIds) {
...
async function provisionGSTConfig(companyId, accountIds) {
...
async function provisionTDSSections(companyId) {
    const sections = [
...
async function provisionFiscalYear(companyId, startMonth) {
    const now = new Date();
...
async function provisionSampleData(companyId, accountIds) {
