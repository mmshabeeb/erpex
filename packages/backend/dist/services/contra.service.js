...
export async function listContraTransactions(companyId, startDate, endDate) {
    const where = { companyId, type: 'CONTRA' };
...
export async function createContraTransaction(companyId, data) {
...
//# sourceMappingURL=contra.service.js.map