...
export async function listItems(companyId, filters) {
...
export async function getItem(companyId, id) {
...
export async function updateItem(companyId, id, data) {
    // Verify ownership
...
// ─── Item Groups ────────────────────────────────────────────
export async function listItemGroups(companyId) {
...
export async function createItemGroup(companyId, data) {
    return prisma.itemGroup.create({ data: { ...data, companyId } });
}
// ─── Price Lists ────────────────────────────────────────────
export async function listPriceLists(companyId) {
...
export async function createPriceList(companyId, data) {
...
export async function updatePriceList(companyId, id, data) {
    ...
    if (items) {
        ...
        await prisma.priceListItem.createMany({
            data: items.map((i) => ({ ...i, priceListId: id })),
        });
    }
