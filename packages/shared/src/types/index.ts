// ============================================================
// ERPEX — Shared TypeScript Interfaces (Full ERP)
// Used by both frontend API client and backend services
// ============================================================

import {
  AccountType, VoucherType, VoucherStatus, TaxType,
  ItemType, ContactType, EstimateStatus, SalesOrderStatus,
...
// ─── Line item base (shared across documents) ──────────────
...
// ═══════════════════════════════════════════════════════════════
// MODULE 5: PROJECTS & TIME TRACKING
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
// BANKING, TAX, FISCAL, REPORTS (existing + extensions)
// ═══════════════════════════════════════════════════════════════
